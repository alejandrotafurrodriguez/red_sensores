...
public class BancoDePruebas {
    ...
    /**
     * Experimento 1: Búsqueda lineal en el peor caso.
     */
    public static void experimentoUno() {
        ...
        for (int n : TAMANOS) {
            ...
            if (posicion < 0) {
                System.out.println("ADVERTENCIA: no encontró una lectura existente.");
            }
        }
        System.out.println();
    }
    ...
    /**
     * Experimento 3: Compara búsqueda de un timestamp inexistente.
     */
    ...
    /**
     * Experimento 4: Demuestra qué ocurre cuando la búsqueda binaria
     * se aplica sobre un campo que no está ordenado (PM2.5).
     */
